...
//doAction
  ...
  function showTable() {
    ...
    if (!isset($extra_query_params))
      $extra_query_params = ""; //this is used by certain applications which require extra query params to be passed (not typical)
  ...
  function makeAjaxEditor($unique_id, $field_name, $field_value, $type = 'textarea', $fieldSize = "", $field_text = "", $onKeyPress_function = "") {
    ...
    if ((strip_tags($cell_data) == "") && $field_value == "")
      $field_text = "--";
